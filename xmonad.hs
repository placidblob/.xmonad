-- xmonad config based on https://github.com/randomthought/xmonad-config
...
--  ++
  ...
  [
    ...
    ((modMask .|. altMask, xK_Left), sendMessage $ pullGroup L)
    -- Tab current focused window with the window to the right
  , ((modMask .|. altMask, xK_Right), sendMessage $ pullGroup R)
    -- Tab current focused window with the window above
  , ((modMask .|. altMask, xK_Up), sendMessage $ pullGroup U)
    -- Tab current focused window with the window below
  , ((modMask .|. altMask, xK_Down), sendMessage $ pullGroup D)
